...
class PaymentDefaultRedeemWidget extends StatefulWidget {
  const PaymentDefaultRedeemWidget({super.key, this.index, this.payment});

  final int? index;
  final DefaultRedeemPaymentModel? payment;

  @override
  State<PaymentDefaultRedeemWidget> createState() => _PaymentDefaultRedeemWidgetState();
}

class _PaymentDefaultRedeemWidgetState extends State<PaymentDefaultRedeemWidget> {
  bool loading = false;
