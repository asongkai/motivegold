...
class AddTambonScreen extends StatefulWidget {
  ...
  @override
  State<AddTambonScreen> createState() => _AddTambonScreenState();
}

class _AddTambonScreenState extends State<AddTambonScreen> {
  ...
  void initState() {
    ...
    amphureNotifier =
        ValueNotifier<AmphureModel>(AmphureModel(nameTh: 'เลือกอำเภอ', id: 0));
  }
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                ...
                Alert.info(context, 'ต้องการบันทึกข้อมูลหรือไม่?', '', 'ตกลง',
                  ...
                  try {
                    var result =
                        await ApiServices.post('/location/tambon', object);
                    await pr.hide();
