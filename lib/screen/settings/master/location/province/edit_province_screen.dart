...
class EditProvinceScreen extends StatefulWidget {
  ...
  const EditProvinceScreen(
      {super.key, required this.province, required this.index});
...
class _EditProvinceScreenState extends State<EditProvinceScreen> {
  ...
  void initState() {
    // implement initState
    super.initState();
    nameTHCtrl.text = widget.province.nameTh ?? '';
    nameENCtrl.text = widget.province.nameEn ?? '';
  }
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                ...
                Alert.info(context, 'ต้องการบันทึกข้อมูลหรือไม่?', '', 'ตกลง',
                  ...
                  try {
                    var result =
                        await ApiServices.put('/location/province', widget.province.id, object);
                    await pr.hide();
