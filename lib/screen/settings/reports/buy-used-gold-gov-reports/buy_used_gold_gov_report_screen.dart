...
import 'package:motivegold/screen/settings/reports/buy-used-gold-gov-reports/preview.dart';
...
class _BuyUsedGoldGovReportScreenState extends State<BuyUsedGoldGovReportScreen> {
  ...
  void loadProducts() async {
    ...
    try {
      var result = await ApiServices.post('/order/all/type/2',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('รายงานบัญชีสำหรับผู้ทำการค้าของเก่า'),
        actions: [
          GestureDetector(
            onTap: () {
