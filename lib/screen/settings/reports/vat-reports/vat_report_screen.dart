...
import 'package:motivegold/screen/settings/reports/vat-reports/preview.dart';
...
class _VatReportScreenState extends State<VatReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('รายงานภาษีขายทองคำรูปพรรณใหม่ 96.5%'),
        actions: [
          GestureDetector(
            onTap: () {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => PreviewVatReportPage(
                    orders: filterList!,
                    type: 1,
