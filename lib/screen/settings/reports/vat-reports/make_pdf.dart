...
Future<Uint8List> makeVatReportPdf(
  ...
  for (DateTime indexDay = DateTime(date.year, date.month, 1);
    ...
    for (int i = 0; i < orders.length; i++) {
      ...
      if (orders[i]!.orderDate == indexDay) {
        ...
        list.add(
            OrderModel(orderId: 'หยุดทำการ/ไม่มียอดขาย', orderDate: indexDay));
      }
    }
  }
      ...
      Expanded(
        child: Row(
          ...
          children: [
            ...
            Expanded(flex: 6, child: Text(Global.branch!.name))
          ],
        ),
      ),
      Expanded(
      ...
      Expanded(
        child: Row(
          ...
          children: [
            ...
            Expanded(flex: 6, child: Text(Global.company!.address ?? ''))
          ],
        ),
      ),
      Expanded(
