...
import 'package:motivegold/screen/settings/setting-value/kyc_setting_screen.dart';
import 'package:motivegold/screen/settings/setting-value/vat_setting_screen.dart';
import 'package:motivegold/utils/global.dart';
import 'package:motivegold/widget/appbar/appbar.dart';
import 'package:motivegold/widget/appbar/title_content.dart';

class SettingValueMenuScreen extends StatelessWidget {
  const SettingValueMenuScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        child: TitleContent(
          backButton: true,
          title: Text("Setting Default Value",
              style: TextStyle(
                  fontSize: 28,
                  color: Colors.white,
