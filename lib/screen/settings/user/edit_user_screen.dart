...
class _EditUserScreenState extends State<EditUserScreen> {
  ...
  void initState() {
    ...
    selectedUserRole = userRoles().where((element) => element.code == widget.user.userRole).first;
    userRoleNotifier =
        ValueNotifier<ProductTypeModel>(selectedUserRole ?? ProductTypeModel(id: 0, name: 'เลือกบทบาทของผู้ใช้'));
    loadData();
  }
  ...
  void loadData() async {
    ...
    try {
      ...
      if (result?.status == "success") {
        ...
        selectedCompany = companies?.where((element) => element.id == widget.user.companyId).first;
        companyNotifier =
  ...
  void loadBranches() async {
    ...
    if (result?.status == "success") {
      ...
      selectedBranch = branches?.where((element) => element.id == widget.user.branchId).first;
        ...
        SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (firstNameCtrl.text.trim() == "" || lastNameCtrl.text == "" || emailCtrl.text == "") {
                  Alert.warning(
                ...
                if (passwordCtrl.text.trim() != "") {
                  if (passwordCtrl.text != cpasswordCtrl.text) {
                    Alert.warning(
                        context, 'warning'.tr(), 'รหัสผ่านไม่เหมือนกัน',
                        'OK'.tr(),
                        action: () {});
                    return;
                  }
