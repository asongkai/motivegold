          ...
          child: Row(
            children: [
              ...
              if (type == 2 || type == 3 || type == 4)
                Expanded(
                  flex: 2,
                  child: Text(type == 4 ? 'เดือน' : 'วันที่',
                      style: TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.bold,
                          color: PdfColors.white),
              ...
              Expanded(
                flex: 2,
                child: Text('ฐานภาษีมูลค่ายกเว้น\nราคาทองคําแท่ง(บาท)',
                    style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: PdfColors.white),
