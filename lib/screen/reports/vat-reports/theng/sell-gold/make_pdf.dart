              ...
              children: [
                ...
                paddedTextSmall(
                    orders[i]!.status == "2"
                        ? "0.00"
                        : Global.format(
                            getPriceExcludeTaxDetailTotal(orders[i]!)),
                    style: TextStyle(
                        fontSize: 10,
                        color: orders[i]!.status == "2"
                            ? PdfColors.red900
            ...
            TableRow(
              ...
              children: [
                paddedTextSmall('${i + 1}',
                    style: TextStyle(
                        fontSize: 10,
                        color: list[i].status == "2" ? PdfColors.red900 : PdfColors.black),
                    align: TextAlign.center),
                ...
                paddedTextSmall(
                    list[i].status == "2"
                        ? "0.00"
                        : Global.format4(list[i].weight ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list[i].status == "2"
                            ? PdfColors.red900
                ...
                paddedTextSmall(
                    list[i].status == "2"
                        ? "0.00"
                        : Global.format(list[i].packageAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list[i].status == "2"
                            ? PdfColors.red900
              ...
              children: [
                paddedTextSmall('${i + 1}',
                    style: TextStyle(
                        fontSize: 10,
                        color:
                            list3[i].status == "2" ? PdfColors.red900 : PdfColors.black),
                    align: TextAlign.center),
                ...
                paddedTextSmall(
                    list3[i].status == "2"
                        ? "0.00"
                        : Global.format4(list3[i].weight ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list3[i].status == "2"
                            ? PdfColors.red900
                ...
                paddedTextSmall(
                    list3[i].status == "2"
                        ? "0.00"
                        : Global.format(list3[i].packageAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list3[i].status == "2"
                            ? PdfColors.red900
        ...
        TableRow(
            ...
            children: [
              ...
              paddedTextSmall(
                  ...
                  align: TextAlign.right),
              paddedTextSmall(
                  Global.format(type == 1
                      ? priceExcludeTaxTotalType(orders)
                      : type == 2
                          ? priceExcludeTaxTotalType2(list)
                          : type == 3
                              ? priceExcludeTaxTotalType2(list3)
                              : priceExcludeTaxTotalType2(orders)),
                  style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.bold,
                      color: PdfColors.black),
                  ...
                  type == 1
                      ...
                      : type == 2
                          ...
                          : type == 3
                              ...
                              : Global.format(
                                  getTotalSellingPriceIncludingVatType2(
                                      orders)),
                  style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.bold,
...
double priceExcludeTaxTotalType(dynamic list) {
  double total = 0;
  for (int i = 0; i < list.length; i++) {
    // Skip "no sales" records
    if (list[i].orderId != 'ไม่มียอดขาย') {
      ...
      // double taxBase = commission + packagePrice;
      // double vatAmount = taxBase * getVatValue();
      // total += (list[i].priceIncludeTax ?? 0) - vatAmount;
      // total += list.fold<double>(
      //     0.0, (sum, order) => sum + getPriceExcludeTaxDetailTotal(order));
      if (list[i] != null) {
        total += getPriceExcludeTaxDetailTotal(list[i]!);
      }
    }
  }
  return total;
