...
Future<Uint8List> makeSellThengVatReportPdf(List<OrderModel?> orders, int type,
  ...
  Widget buildHeader() {
    return Column(
      children: [
        ...
        Center(
          child: Text(
            'รายงานภาษีมูลค่าเพิ่ม : รายงานภาษีขายทองคำแท่ง',
            style: TextStyle(
        ...
        Container(
          ...
          child: Row(
            children: [
              Expanded(flex: 1, child: Text('ลําดับ', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              if (type == 2 || type == 3 || type == 4)
                Expanded(flex: 2, child: Text(type == 4 ? 'เดือน' : 'วันที่', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              if (type == 1)
                Expanded(flex: 2, child: Text('เลขที่\nใบกํากับภาษี', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              if (type == 1)
              ...
              if (type == 1)
                Expanded(flex: 2, child: Text('ชื่อผู้ซื้อ', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              if (type == 1)
              ...
              if (type == 2 || type == 3 || type == 4)
                Expanded(flex: 2, child: Text('เลขที่\nใบกํากับภาษี', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              if (type == 2 || type == 3 || type == 4)
                Expanded(flex: 2, child: Text('รายการสินค้า', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('น้ำหนักรวม\n(บาท)', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('น้ำหนักรวม\n(กรัม)', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('ฐานภาษีมูลค่ายกเว้น\nราคาทองคําแท่ง(บาท)', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('ค่าบล็อกทอง', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('ค่าบรรจุภัณฑ์', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('รวมมูลค่าฐานภาษี', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('ภาษีมูลค่าเพิ่ม\nจำนวนเงิน (บาท)', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
              Expanded(flex: 2, child: Text('ราคาขาย\nรวมภาษีมูลค่าเพิ่ม\n(บาท)', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: PdfColors.white))),
            ],
          ),
        ),
      ],
                ...
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" : Global.format4(getWeight(orders[i]!)),
                    style: TextStyle(
                        ...
                        color: orders[i]!.status == "2"
                            ...
                            : PdfColors.blue600),
                    align: TextAlign.right),
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" : Global.format(getPriceExcludeTaxDetailTotal(orders[i]!)),
                    style: TextStyle(
                        fontSize: 10,
                        color: orders[i]!.status == "2"
                            ? PdfColors.red900
                    ...
                    align: TextAlign.right),
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" :
                Global.format(getCommissionNoVat(orders[i]!)),
                    style: TextStyle(
                        fontSize: 10,
                        color: orders[i]!.status == "2"
                            ? PdfColors.red900
                    ...
                    align: TextAlign.right),
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" :
                Global.format(getPackageNoVat(orders[i]!)),
                    style: TextStyle(
                        fontSize: 10,
                        color: orders[i]!.status == "2"
                            ? PdfColors.red900
                    ...
                    align: TextAlign.right),
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" :
                Global.format(getCommissionNoVat(orders[i]!) + getPackageNoVat(orders[i]!)),
                    style: TextStyle(
                        fontSize: 10,
                        color: orders[i]!.status == "2"
                            ? PdfColors.red900
                ...
                paddedTextSmall(list[i].status == "2" ? "0.00" : Global.format4(list[i].weight ?? 0),
                    style: TextStyle(
                        ...
                        color: list[i].status == "2"
                            ...
                            : PdfColors.blue600),
                    align: TextAlign.right),
                paddedTextSmall(list[i].status == "2" ? "0.00" : Global.format(list[i].priceExcludeTax ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list[i].status == "2"
                            ? PdfColors.red900
                            : PdfColors.green600),
                    align: TextAlign.right),
                paddedTextSmall(list[i].status == "2" ? "0.00" : Global.format(list[i].commissionAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list[i].status == "2"
                            ? PdfColors.red900
                            : PdfColors.orange600),
                    align: TextAlign.right),
                paddedTextSmall(list[i].status == "2" ? "0.00" : Global.format(list[i].packageAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list[i].status == "2"
                            ? PdfColors.red900
          ...
          for (int i = 0; i < list3.length; i++)
            TableRow(
              ...
              children: [
                ...
                Global.format((list3[i].weightBath ?? 0)),
                    style: TextStyle(
                        fontSize: 10,
                        color: list3[i].status == "2"
                            ? PdfColors.red900
                ...
                paddedTextSmall(list3[i].status == "2" ? "0.00" : Global.format4(list3[i].weight ?? 0),
                    style: TextStyle(
                        ...
                        color: list3[i].status == "2"
                            ...
                            : PdfColors.blue600),
                    align: TextAlign.right),
                paddedTextSmall(list3[i].status == "2" ? "0.00" : Global.format(list3[i].priceExcludeTax ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list3[i].status == "2"
                            ? PdfColors.red900
                            : PdfColors.green600),
                    align: TextAlign.right),
                paddedTextSmall(list3[i].status == "2" ? "0.00" : Global.format(list3[i].commissionAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list3[i].status == "2"
                            ? PdfColors.red900
                            : PdfColors.orange600),
                    align: TextAlign.right),
                paddedTextSmall(list3[i].status == "2" ? "0.00" : Global.format(list3[i].packageAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: list3[i].status == "2"
                            ? PdfColors.red900
                ...
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" : Global.format(orders[i]!.priceExcludeTax ?? 0),
                    style: TextStyle(
                        ...
                        color: orders[i]!.status == "2"
                            ...
                            : PdfColors.green600),
                    align: TextAlign.right),
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" : Global.format(orders[i]!.commissionAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: orders[i]!.status == "2"
                            ? PdfColors.red900
                            : PdfColors.orange600),
                    align: TextAlign.right),
                paddedTextSmall(orders[i]!.status == "2" ? "0.00" : Global.format(orders[i]!.packageAmount ?? 0),
                    style: TextStyle(
                        fontSize: 10,
                        color: orders[i]!.status == "2"
                            ? PdfColors.red900
            ...
            children: [
              ...
              paddedTextSmall(
                  ...
                  style: TextStyle(
                      ...
                      color: PdfColors.blue700),
                  align: TextAlign.right),
              paddedTextSmall(Global.format(type == 1 ? getPriceExcludeTaxHeadTotal(orders) : priceExcludeTaxTotal(orders)),
                  style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.bold,
              ...
              paddedTextSmall(
                  type == 1
                      ...
                      : type == 2
                          ? Global.format(getCommissionTotalType2(list))
                          : type == 3
                              ? Global.format(getCommissionTotalType2(list3))
              ...
              paddedTextSmall(
                  type == 1
                      ...
                      : type == 2
                          ? Global.format(getPackagePriceTotalType2(list))
                          : type == 3
                              ? Global.format(getPackagePriceTotalType2(list3))
              ...
              paddedTextSmall(
                  type == 1
                      ...
                      : type == 2
                          ? Global.format(getTaxBaseTotalType2(list))
                          : type == 3
                              ? Global.format(getTaxBaseTotalType2(list3))
              ...
              paddedTextSmall(
                  type == 1
                      ...
                      : type == 2
                          ? Global.format(getVatAmountTotalType2(list))
                          : type == 3
                              ? Global.format(getVatAmountTotalType2(list3))
              ...
              paddedTextSmall(
                  type == 1
                      ...
                      : type == 2
                          ? Global.format(
                              getTotalSellingPriceIncludingVatType2(list))
                          : type == 3
                              ? Global.format(
                                  getTotalSellingPriceIncludingVatType2(list3))
                              : Global.format(
...
double getCommissionTotalType2(dynamic list) {
  ...
  for (int i = 0; i < list.length; i++) {
    ...
    if (list[i].orderId != 'ไม่มียอดขาย') {
      total += list[i].commissionAmount ?? 0; //getCommissionDetailTotal(list[i]);
    }
  }
  return total;
}
...
double getPackagePriceTotalType2(dynamic list) {
  ...
  for (int i = 0; i < list.length; i++) {
    // Skip "no sales" records
    if (list[i].orderId != 'ไม่มียอดขาย') {
      total += list[i].packageAmount ?? 0; //getPackagePriceDetailTotal(list[i]);
    }
  }
  return total;
}
...
double getTaxBaseTotalType2(dynamic list) {
  ...
  for (int i = 0; i < list.length; i++) {
    // Skip "no sales" records
    if (list[i].orderId != 'ไม่มียอดขาย') {
      total += (list[i].commissionAmount ?? 0) + (list[i].packageAmount ?? 0); //getCommissionDetailTotal(list[i]) + getPackagePriceDetailTotal(list[i]);
    }
  }
  return total;
}
...
double getVatAmountTotalType2(dynamic list) {
  ...
  for (int i = 0; i < list.length; i++) {
    // Skip "no sales" records
    if (list[i].orderId != 'ไม่มียอดขาย') {
      double taxBase = (list[i].commissionAmount ?? 0) + (list[i].packageAmount ?? 0); //getCommissionDetailTotal(list[i]) + getPackagePriceDetailTotal(list[i]);
      total += taxBase * getVatValue();
    }
  }
  return total;
...
double getTotalSellingPriceIncludingVatType2(dynamic list) {
  ...
  for (int i = 0; i < list.length; i++) {
    ...
    if (list[i].orderId != 'ไม่มียอดขาย') {
      ...
      // double commission = list[i].commissionAmount ?? 0; //getCommissionDetailTotal(list[i]);
      // double packagePrice = list[i].packageAmount ?? 0; //getPackagePriceDetailTotal(list[i]);
      // double taxBase = commission + packagePrice;
      // double vatAmount = taxBase * getVatValue();
      //
      // total += priceIncludeTax + taxBase + vatAmount;
