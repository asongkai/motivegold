...
class SellThengVatReportScreen extends StatefulWidget {
  const SellThengVatReportScreen({super.key});

  @override
  State<SellThengVatReportScreen> createState() =>
      _SellThengVatReportScreenState();
}

class _SellThengVatReportScreenState extends State<SellThengVatReportScreen> {
  bool loading = false;
          ...
          title: Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 6,
                  child: Text("รายงานภาษีขายทองคำแท่ง",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.white,
      ...
      onSelected: (int value) async {
        if (value == 1) {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => PreviewSellThengVatReportPage(
                ...
                child: IntrinsicWidth(
                  child: Column(
                    children: [
                      ...
                      // Data Rows - 13 columns matching PDF Type 1
                      Expanded(
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          padding: const EdgeInsets.symmetric(horizontal: 4),
                                          child: Text(
                                            isCancelled ? '0.00' : Global.format(getPriceExcludeTaxDetailTotal(item)),
                                            style: TextStyle(fontSize: 10, color: textColor),
                                            textAlign: TextAlign.right,
                                            overflow: TextOverflow.ellipsis,
                                          ),
                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  double totalPriceExcludeTax = filterList!.fold<double>(
                                  ...
                                  return Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        // 4. Empty for ชื่อผู้ซื้อ
                                        Expanded(flex: 2, child: Container()),
                                        // 5. รวมท้ังหมด label (in tax number column)
                                        Expanded(
                                          flex: 2,
                                          child: Container(
                                            padding: const EdgeInsets.symmetric(horizontal: 4),
