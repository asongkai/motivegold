    ...
    return Column(children: [
      ...
      Table(
        border: TableBorder(
          ...
          horizontalInside: BorderSide(color: PdfColors.white, width: 0.5),
        ...
        columnWidths: {
          ...
          10: const FixedColumnWidth(55),
          11: const FixedColumnWidth(45),
          12: const FixedColumnWidth(35),
          13: const FixedColumnWidth(35),
      ...
      children: [
        ...
        TableRow(
          ...
          children: [
            ...
            paddedTextSmall(
                type == 1
                    ? Global.format(orders.fold(
                        0.0, (sum, order) => sum + getWeight(order)))
                    : Global.format(orders.fold(
                        0.0, (sum, order) => sum + (order?.weight ?? 0))),
                style: TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.bold,
            ...
            paddedTextSmall(
                Global.format(orders.fold(
                    0.0, (sum, order) => sum + (order?.priceIncludeTax ?? 0))),
                style: TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.bold,
