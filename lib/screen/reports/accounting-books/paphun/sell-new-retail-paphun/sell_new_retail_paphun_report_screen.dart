...
import 'package:motivegold/screen/reports/accounting-books/paphun/sell-new-retail-paphun/preview.dart';
...
class SellNewRetailPaphunReportScreen extends StatefulWidget {
  const SellNewRetailPaphunReportScreen({super.key});

  @override
  State<SellNewRetailPaphunReportScreen> createState() =>
      _SellNewRetailPaphunReportScreenState();
}

class _SellNewRetailPaphunReportScreenState
    extends State<SellNewRetailPaphunReportScreen> {
  bool loading = false;
          ...
          title: Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 6,
                  child: Text("สมุดบัญชีขายทองรูปพรรณใหม่",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.white,
    ...
    return PopupMenuButton<int>(
      onSelected: (int value) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => PreviewSellNewRetailPaphunReportPage(
              orders: ordersToPass,
              type: value,
                        ...
                        child: IntrinsicHeight(
                          child: Row(
                            children: [
                              ...
                              // 6. Credit - Sell Gold (เครดิต: ขายทองรูปพรรณใหม่)
                              Expanded(
                                flex: 2,
                                child: Container(
                                  padding: const EdgeInsets.all(8),
