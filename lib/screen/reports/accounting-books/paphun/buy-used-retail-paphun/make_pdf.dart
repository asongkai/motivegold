...
Future<Uint8List> makeBuyUsedRetailPaphunReportPdf(List<OrderModel?> orders,
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            // Column 1: เลขที่ใบรับซื้อทองเก่า (spans 2 rows)
            Expanded(
              flex: 2,
              child: Container(
                decoration: BoxDecoration(
  ...
  // For type 1: [2, 2, 4, 2, 2] total = 12
  // For type 2/3: [2, 2, 2, 2] total = 8
...
// Purchase amount (NO VAT for buy-used-retail-paphun)
double getPurchaseAmount(OrderModel order) {
  return (order.priceIncludeTax ?? 0);
}

// Cash/Bank = same as purchase amount (NO VAT)
