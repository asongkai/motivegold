...
import 'package:motivegold/screen/reports/accounting-books/paphun/buy-used-retail-paphun/preview.dart';
...
class BuyUsedRetailPaphunReportScreen extends StatefulWidget {
  const BuyUsedRetailPaphunReportScreen({super.key});

  @override
  State<BuyUsedRetailPaphunReportScreen> createState() =>
      _BuyUsedRetailPaphunReportScreenState();
}

class _BuyUsedRetailPaphunReportScreenState
    extends State<BuyUsedRetailPaphunReportScreen> {
  bool loading = false;
          ...
          title: Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 6,
                  child: Text("สมุดบัญชีซื้อทองรูปพรรณเก่า",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.white,
    ...
    return PopupMenuButton<int>(
      onSelected: (int value) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => PreviewBuyUsedRetailPaphunReportPage(
              orders: ordersToPass,
              type: value,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'รายงานสมุดบัญชีทองรูปพรรณ (${filterList!.length} รายการ)',
                    style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        ...
                        child: IntrinsicHeight(
                          child: Row(
                            children: [
                              ...
                              // 2. Order ID (เลขที่ใบรับซื้อทองเก่า)
                              Expanded(
                                flex: 2,
                                child: Container(
                                  padding: const EdgeInsets.all(8),
                              ...
                              // 5. Purchase Amount (เดบิต: ซื้อทองรูปพรรณเก่า)
                              Expanded(
                                flex: 2,
                                child: Container(
                                  padding: const EdgeInsets.all(8),
                              ...
                              // 6. Cash/Bank (เครดิต: เงินสด/ธนาคาร)
                              Expanded(
                                flex: 2,
                                child: Container(
                                  padding: const EdgeInsets.all(8),
                                ...
                                child: IntrinsicHeight(
                                  child: Row(
                                    children: [
                                      ...
                                      // 6. Cash/Bank total (same as Purchase Amount)
                                      Expanded(
                                        flex: 2,
                                        child: Container(
                                          padding: const EdgeInsets.all(8),
