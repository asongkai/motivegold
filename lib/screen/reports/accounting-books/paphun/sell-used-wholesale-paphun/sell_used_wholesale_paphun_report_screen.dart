...
import 'package:motivegold/screen/reports/accounting-books/paphun/sell-used-wholesale-paphun/preview.dart';
...
class SellUsedWholesalePaphunReportScreen extends StatefulWidget {
  const SellUsedWholesalePaphunReportScreen({super.key});

  @override
  State<SellUsedWholesalePaphunReportScreen> createState() =>
      _SellUsedWholesalePaphunReportScreenState();
}

class _SellUsedWholesalePaphunReportScreenState
    extends State<SellUsedWholesalePaphunReportScreen> {
  bool loading = false;
  ...
  Future<void> search() async {
    ...
    try {
      ...
      if (result?.status == "success") {
        ...
        motivePrint("API returned ${products.length} orders");
        setState(() {
          ...
          title: Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 6,
                  child: Text("สมุดบัญชีขายทองรูปพรรณเก่า",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.white,
    ...
    return PopupMenuButton<int>(
      onSelected: (int value) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => PreviewSellUsedWholesalePaphunReportPage(
              orders: ordersToPass,
              type: value,
