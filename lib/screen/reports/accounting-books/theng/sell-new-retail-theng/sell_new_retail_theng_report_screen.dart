...
import 'package:motivegold/screen/reports/accounting-books/theng/sell-new-retail-theng/preview.dart';
...
class SellNewRetailThengReportScreen extends StatefulWidget {
  const SellNewRetailThengReportScreen({super.key});

  @override
  State<SellNewRetailThengReportScreen> createState() =>
      _SellNewRetailThengReportScreenState();
}

class _SellNewRetailThengReportScreenState
    extends State<SellNewRetailThengReportScreen> {
  bool loading = false;
          ...
          title: Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 6,
                  child: Text("สมุดบัญชีขายทองคำแท่งหน้าร้าน",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.white,
    ...
    return PopupMenuButton<int>(
      onSelected: (int value) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => PreviewSellNewRetailThengReportPage(
              orders: ordersToPass,
              type: value,
  ...
  Widget _buildEnhancedDataTable() {
    ...
    for (var item in filterList!) {
      if (item?.status != "2") {
        ...
        totalGoldValue += item?.priceIncludeTax ?? 0;
            ...
            child: SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: IntrinsicWidth(
                  child: Column(
                    children: [
                      // Sticky Header - matches PDF Type 1 structure (SELL report)
                      Container(
                        ...
                        child: IntrinsicHeight(
                          child: Row(
                            children: [
                              ...
                              // Credit: ต้นทุนค่าบล็อก/ค่าบรรจุภัณฑ์
                              Expanded(
                                flex: 2,
                                child: Container(
                                  padding: const EdgeInsets.all(8),
                      ...
                      // Data Rows - matches PDF Type 1 structure (SELL report)
                      Expanded(
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                                ...
                                child: IntrinsicHeight(
                                  child: Row(
                                    children: [
                                      ...
                                      // Credit - Commission/Package total
                                      Expanded(
                                        flex: 2,
                                        child: Container(
                                          padding: const EdgeInsets.all(8),
