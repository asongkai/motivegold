...
Future<Uint8List> makeSellNewRetailThengReportPdf(List<OrderModel?> orders,
  ...
  // For type 1: [3, 2, 4, 2, 2, 2, 2] total = 17
  ...
  Map<int, TableColumnWidth> columnWidths = type == 1
      ? {
          ...
          4: FlexColumnWidth(2),      // Gold Value
          5: FlexColumnWidth(2),      // Commission/Package
          6: FlexColumnWidth(2),      // VAT Amount
        }
      : {
          0: FlexColumnWidth(3),      // Order ID
          1: FlexColumnWidth(2),      // Date
          2: FlexColumnWidth(2),      // Cash/Bank
