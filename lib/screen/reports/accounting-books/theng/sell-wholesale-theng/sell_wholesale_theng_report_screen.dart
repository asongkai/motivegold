...
import 'package:motivegold/screen/reports/accounting-books/theng/sell-wholesale-theng/preview.dart';
...
class SellWholesaleThengReportScreen extends StatefulWidget {
  const SellWholesaleThengReportScreen({super.key});

  @override
  State<SellWholesaleThengReportScreen> createState() =>
      _SellWholesaleThengReportScreenState();
}

class _SellWholesaleThengReportScreenState
    extends State<SellWholesaleThengReportScreen> {
  bool loading = false;
          ...
          title: Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 6,
                  child: Text("สมุดบัญชีขายทองคำแท่งให้ร้านค้าส่ง",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.white,
    ...
    return PopupMenuButton<int>(
      onSelected: (int value) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => PreviewSellWholesaleThengReportPage(
              orders: ordersToPass,
              type: value,
