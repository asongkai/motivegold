...
class SellNewGoldReportScreen extends StatefulWidget {
  ...
  @override
  State<SellNewGoldReportScreen> createState() =>
      _SellNewGoldReportScreenState();
}
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'รายงานขายทองใหม่ (${filterList!.length} รายการ)',
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          padding: const EdgeInsets.all(8),
                                          child: Text(
                                            Global.format(priceDiffTotal(filterList as dynamic)),
                                            style: TextStyle(
                                              fontWeight: FontWeight.w700,
                                              fontSize: 10,
