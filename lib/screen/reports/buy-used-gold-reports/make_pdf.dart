        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: paddedTextSmall(type == 4 ? 'เดือน' : 'วันที่',
                    style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: PdfColors.white),
              ...
              Expanded(
                flex: 1,
                child: paddedTextSmall('เลขท่ีใบสําคัญ\nรับเงิน',
                    style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: PdfColors.white),
              ...
              if (type == 1)
                Expanded(
                  flex: 1,
                  child: paddedTextSmall('เลขประจําตัว\nผู้เสียภาษี',
                      style: TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.bold,
                          color: PdfColors.white),
              ...
              Expanded(
                flex: 1,
                child: paddedTextSmall('รายการสินค้า',
                    style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: PdfColors.white),
              ...
              Expanded(
                flex: 1,
                child: paddedTextSmall('น้ําหนัก\n(กรัม)',
                    style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: PdfColors.white),
              ...
              Expanded(
                flex: 1,
                child: paddedTextSmall('จํานวนเงิน\n(บาท)',
                    style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: PdfColors.white),
