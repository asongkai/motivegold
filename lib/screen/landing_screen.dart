    ...
    try {
      ...
      if (lang != null) {
        ...
        LocalStorage.sharedInstance
            .writeValue(key: 'lang', value: 0.toString());
        if (mounted) {
          context.setLocale(const Locale('en', 'US'));
        }
      }
      ...
      if (kIsWeb) {
        Global.deviceDetail =
            readWebBrowserInfo(await deviceInfo.webBrowserInfo);
      ...
      if (Global.isLoggedIn == false) {
        ...
        var province = await ApiServices.post(
            '/customer/province', Global.requestObj(null));
