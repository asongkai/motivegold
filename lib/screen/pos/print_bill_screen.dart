...
class _PrintBillScreenState extends State<PrintBillScreen> {
  ...
  void loadOrder() async {
    ...
    try {
      List<String>? ids = Global.orderIds;
      // print(ids);
      var result = await ApiServices.post('/order/order-list', encoder.convert(ids));
      // print(result!.data);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: loading ? const LoadingProgress() : GestureDetector(
          onTap: () {
                      ...
                      children: [
                        ...
                        TableRow(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(20),
                              child: Text(formatter.format(Global.getOrderWeightTotalAmountApi(order.details)),
                                  textAlign: TextAlign.center,
                                  style:
                                  TextStyle(fontSize: size?.getWidthPx(8))),
                            ),
                            Padding(
                              padding: const EdgeInsets.all(20),
                              child: Text(formatter.format(Global.getOrderSubTotalAmountApi(order.details)),
                                  textAlign: TextAlign.center,
                                  style:
                                  TextStyle(fontSize: size?.getWidthPx(8))),
                            ),
                        ...
                        TableRow(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(20),
                              child: Text(formatter.format(order.discount ?? 0),
                                  textAlign: TextAlign.center,
                                  style:
                                  TextStyle(fontSize: size?.getWidthPx(8))),
                            ),
                        ...
                        TableRow(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(20),
                              child: Text(formatter.format(Global.getOrderGrantTotalAmountApi(Global.getOrderSubTotalAmountApi(order.details), order.discount) ),
                                  textAlign: TextAlign.center,
                                  style:
                                  TextStyle(fontSize: size?.getWidthPx(8))),
                            ),
                    ...
                    GestureDetector(
                      onTap: () {
                        Invoice invoice = Invoice(
                          order: order,
                            customer: order.customer!, items: order.details!);
