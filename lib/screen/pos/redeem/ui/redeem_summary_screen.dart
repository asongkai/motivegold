...
class RedeemSummaryHistoryScreen extends StatefulWidget {
  const RedeemSummaryHistoryScreen({super.key});

  @override
  State<RedeemSummaryHistoryScreen> createState() =>
      _RedeemSummaryHistoryScreenState();
}

class _RedeemSummaryHistoryScreenState
    extends State<RedeemSummaryHistoryScreen>
  ...
  void loadData() async {
    ...
    try {
      ...
      // motivePrint(data);
      orders = redeemListModelFromJson(data);
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  '${Global.format(Global.getRedeemPaymentTotal(orders, discount: Global.toNumber(discountCtrl.text)))} บาท',
                ...
                for (int j = 0; j < order.details!.length; j++)
                  TableRow(
                    ...
                    children: [
                      ...
                      paddedTextBigL('ทองคำรูปพรรณ 96.5%',
                          style: TextStyle(fontSize: 16.sp)),
                      paddedTextBigL(Global.format(order.details![j].weight!),
                          align: TextAlign.right,
                          style: TextStyle(fontSize: 16.sp)),
                      paddedTextBigL(
                          Global.format(order.details![j].paymentAmount) +
                              '  บาท',
                          align: TextAlign.right,
                          style: TextStyle(
                            fontSize: 16.sp,
