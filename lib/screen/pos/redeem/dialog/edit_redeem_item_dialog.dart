...
class EditRedeemItemDialog extends StatefulWidget {
  const EditRedeemItemDialog(
      {super.key, required this.vatOption, required this.index, this.j});
  ...
  @override
  State<EditRedeemItemDialog> createState() => _EditRedeemItemDialogState();
}

class _EditRedeemItemDialogState extends State<EditRedeemItemDialog> {
  bool loading = false;
  ...
  void initState() {
    ...
    referenceNumberCtrl.text = widget.j == null
        ? Global.redeemSingleDetail![widget.index].referenceNo ?? ''
        : Global.redeems[widget.index].details![widget.j!].referenceNo ?? '';
    weightGramCtrl.text = widget.j == null
        ? Global.format(Global.redeemSingleDetail![widget.index].weight ?? 0)
        : Global.format(
            Global.redeems[widget.index].details![widget.j!].weight ?? 0);
    weightBahtCtrl.text = widget.j == null
        ? Global.format(
            Global.redeemSingleDetail![widget.index].weightBath ?? 0)
        : Global.format(
            Global.redeems[widget.index].details![widget.j!].weightBath ?? 0);
    depositAmountCtrl.text = widget.j == null
        ? Global.format(
            Global.redeemSingleDetail![widget.index].depositAmount ?? 0)
        : Global.format(
            Global.redeems[widget.index].details![widget.j!].depositAmount ??
                0);
    redeemValueCtrl.text = widget.j == null
        ? Global.format(
            Global.redeemSingleDetail![widget.index].redemptionValue ?? 0)
        : Global.format(
            Global.redeems[widget.index].details![widget.j!].redemptionValue ??
                0);
    benefitTotalCtrl.text = widget.j == null
        ? Global.format(
            Global.redeemSingleDetail![widget.index].taxBaseAmount ?? 0)
        : Global.format(
            Global.redeems[widget.index].details![widget.j!].taxBaseAmount ??
                0);
    benefitReceiveCtrl.text = widget.j == null
        ? Global.format(
            Global.redeemSingleDetail![widget.index].benefitAmount ?? 0)
        : Global.format(
            Global.redeems[widget.index].details![widget.j!].benefitAmount ??
                0);
    totalAmount = widget.j == null
        ? Global.redeemSingleDetail![widget.index].paymentAmount ?? 0
        : Global.redeems[widget.index].details![widget.j!].paymentAmount ?? 0;
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      Alert.info(
                          ...
                          action: () async {
                        if (widget.j == null) {
                          Global.redeemSingleDetail![widget.index] =
                          ...
                          Global.redeems![widget.index].details![widget.j!] =
                              RedeemDetailModel.fromJson(
                            jsonDecode(
                              jsonEncode(
                                RedeemDetailModel(
