...
class PdfPreviewRedeemPage extends StatefulWidget {
  ...
  @override
  State<PdfPreviewRedeemPage> createState() => _PdfPreviewRedeemPageState();
}

class _PdfPreviewRedeemPageState extends State<PdfPreviewRedeemPage> {
  int option = 1;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PdfPreview(
        build: (context) => makeRedeemSingleBillPdf(widget.invoice, option: option),
      ),
    );
  }
