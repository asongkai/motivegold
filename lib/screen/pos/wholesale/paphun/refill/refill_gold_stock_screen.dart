                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Center(
                                child: Global.refillAttach == null && Global.refillAttachWeb == null
                                    ? Text(
                                  'ไม่ได้เลือกรูปภาพ',
                                    ...
                                    child: Stack(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: kIsWeb
                                              ? Image.memory(base64Decode(Global.refillAttachWeb!.split(",").last))
                                              : Image.file(Global.refillAttach!),
                                        ),
                                        Positioned(
                                          right: 0.0,
                                          top: 0.0,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (priceExcludeTaxCtrl.text.isEmpty) {
                          Alert.warning(context, 'คำเตือน',
                              'กรุณากรอกราคารวมค่ากำเหน็จก่อนภาษี', 'OK',
                              action: () {});
                          return;
                        }
