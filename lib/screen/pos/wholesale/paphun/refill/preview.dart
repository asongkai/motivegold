...
class PreviewRefillGoldPage extends StatefulWidget {
  final Invoice invoice;
  final bool goHome;
  const PreviewRefillGoldPage({super.key, required this.invoice, this.goHome = false});

  @override
  State<PreviewRefillGoldPage> createState() => _PreviewRefillGoldPageState();
}

class _PreviewRefillGoldPageState extends State<PreviewRefillGoldPage> {
  int option = 1;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PdfPreview(
        build: (context) => makeRefillBill(widget.invoice, option: option),
      ),
    );
  }
