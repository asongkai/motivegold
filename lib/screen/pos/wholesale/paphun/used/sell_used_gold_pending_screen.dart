...
class SellUsedGoldPendingScreen extends StatefulWidget {
  const SellUsedGoldPendingScreen({super.key});

  @override
  State<SellUsedGoldPendingScreen> createState() =>
      _SellUsedGoldPendingScreenState();
}

class _SellUsedGoldPendingScreenState extends State<SellUsedGoldPendingScreen> {
  bool loading = false;
