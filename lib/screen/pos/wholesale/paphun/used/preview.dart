...
class PreviewSellUsedGoldPage extends StatefulWidget {
  final Invoice invoice;
  final bool goHome;
  const PreviewSellUsedGoldPage({super.key, required this.invoice, this.goHome = false});

  @override
  State<PreviewSellUsedGoldPage> createState() => _PreviewSellUsedGoldPageState();
}

class _PreviewSellUsedGoldPageState extends State<PreviewSellUsedGoldPage> {
  int option = 1;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PdfPreview(
        build: (context) => makeSellUsedBill(widget.invoice, option: option),
      ),
    );
  }
