...
class SellUsedGoldScreenOld extends StatefulWidget {
  final Function(dynamic value) refreshCart;
  final int cartCount;

  const SellUsedGoldScreenOld(
      {super.key, required this.refreshCart, required this.cartCount});

  @override
  State<SellUsedGoldScreenOld> createState() => _SellUsedGoldScreenOldState();
}

class _SellUsedGoldScreenOldState extends State<SellUsedGoldScreenOld> {
  bool loading = false;
  Screen? size;
