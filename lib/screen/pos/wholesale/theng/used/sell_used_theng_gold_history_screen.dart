...
class SellUsedThengGoldHistoryScreen extends StatefulWidget {
  const SellUsedThengGoldHistoryScreen({super.key});

  @override
  State<SellUsedThengGoldHistoryScreen> createState() =>
      _SellUsedThengGoldHistoryScreenState();
}

class _SellUsedThengGoldHistoryScreenState extends State<SellUsedThengGoldHistoryScreen> {
  bool loading = false;
