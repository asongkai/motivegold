...
class PreviewSellUsedThengGoldPage extends StatefulWidget {
  final Invoice invoice;
  final bool goHome;
  const PreviewSellUsedThengGoldPage({super.key, required this.invoice, this.goHome = false});

  @override
  State<PreviewSellUsedThengGoldPage> createState() => _PreviewSellUsedThengGoldPageState();
}

class _PreviewSellUsedThengGoldPageState extends State<PreviewSellUsedThengGoldPage> {
  int option = 1;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PdfPreview(
        build: (context) => makeSellUsedThengBill(widget.invoice, option: option),
      ),
    );
  }
