...
class EditRefillThengGoldStockScreen extends StatefulWidget {
  ...
  const EditRefillThengGoldStockScreen(
      {super.key, required this.index, this.j});

  @override
  State<EditRefillThengGoldStockScreen> createState() =>
      _EditRefillThengGoldStockScreenState();
}

class _EditRefillThengGoldStockScreenState
    extends State<EditRefillThengGoldStockScreen> {
  bool loading = false;
  ...
  void initState() {
    ...
    productSellThengPriceCtrl.text = Global.format(
        Global.ordersThengWholesale![widget.index].sellTPrice ?? 0);
    productBuyThengPriceCtrl.text = Global.format(
        Global.ordersThengWholesale![widget.index].buyTPrice ?? 0);
    productWeightCtrl.text = Global.format(
        Global.ordersThengWholesale![widget.index].details![widget.j!].weight ??
            0);
    productWeightBahtCtrl.text = Global.format(Global
    ...
    priceExcludeTaxCtrl.text = Global.format(Global
            ...
            .priceExcludeTax ??
        0);
    productCommissionCtrl.text = Global.format(Global
            .ordersThengWholesale![widget.index]
            .details![widget.j!]
            .commission ??
        0);
    purchasePriceCtrl.text = Global.format(Global
            ...
            .purchasePrice ??
        0);
    priceDiffCtrl.text = Global.format(Global
            .ordersThengWholesale![widget.index]
            .details![widget.j!]
            .priceDiff ??
        0);
    taxAmountCtrl.text = Global.format(Global
            .ordersThengWholesale![widget.index]
            .details![widget.j!]
            .taxAmount ??
        0);
    taxBaseCtrl.text = Global.format(Global
            .ordersThengWholesale![widget.index].details![widget.j!].taxBase ??
        0);
  ...
  void loadProducts() async {
    ...
    try {
      ...
      if (pg?.status == "success") {
        ...
        selectedPackage = (Global.ordersThengWholesale![widget.index]
                    .details![widget.j!].packageId !=
                null)
            ? packageList
                .where((e) =>
                    e.id ==
                    Global.ordersThengWholesale![widget.index]
                        .details![widget.j!].packageId)
                .first
            : null;
        packageNotifier = ValueNotifier<ProductModel>(
        ...
        packageQtyCtrl.text = formatterInt.format(Global
            .ordersThengWholesale![widget.index]
            .details![widget.j!]
            .packageQty);
        packagePriceCtrl.text = Global.format(Global
            .ordersThengWholesale![widget.index]
            .details![widget.j!]
            .packagePrice);
      } else {
