...
Future<Uint8List> makeRefillThengBill(Invoice invoice, {int option = 1}) async {
      ...
      return Row(
        children: [
          Expanded(
            flex: 5,
            child:
                Text('ขายทองคำแท่ง : ${orders[i].orderId}', style: const TextStyle(fontSize: 10)),
          ),
          Expanded(
              flex: 3,
              child: Text(
    ...
    if (orders[i].orderTypeId == 10) {
      return Row(
        children: [
          Expanded(
            flex: 5,
            child: Text('ซื้อทองแท่ง : ${orders[i].orderId}', style: const TextStyle(fontSize: 10)),
          ),
          Expanded(
              flex: 3,
              child: Text(
