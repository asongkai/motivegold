...
class RefillThengGoldHistoryScreen extends StatefulWidget {
  ...
  @override
  State<RefillThengGoldHistoryScreen> createState() =>
      _RefillThengGoldHistoryScreenState();
}

class _RefillThengGoldHistoryScreenState extends State<RefillThengGoldHistoryScreen> {
  bool loading = false;
