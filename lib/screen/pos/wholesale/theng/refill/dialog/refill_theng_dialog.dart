...
class RefillThengDialog extends StatefulWidget {
  const RefillThengDialog({super.key});

  @override
  State<RefillThengDialog> createState() => _RefillThengDialogState();
}

class _RefillThengDialogState extends State<RefillThengDialog> {
  bool loading = false;
