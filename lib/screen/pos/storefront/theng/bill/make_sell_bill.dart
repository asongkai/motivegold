...
Future<Uint8List> makeSellThengBill(Invoice invoice, {int option = 1}) async {
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                            flex: 8,
                            child: Text(
                                'ค่าบริการ ค่าสินค้าที่มีภาษีมูลค่าเพิ่ม :',
                                style: TextStyle(
                                    fontSize: 12,
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            flex: 8,
                            child: Text(
                                'รวมค่าบริการ/ค่าสินค้าก่อนภาษีมูลค่าเพิ่ม :',
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            flex: 8,
                            child: Text(
                                'รวมสุทธิทองคำแท่ง และค่าบริการ/ค่าสินค้า (รวมภาษีมูลค่าเพิ่ม) :',
                                textAlign: TextAlign.right,
                                style: TextStyle(
