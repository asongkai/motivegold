...
class PreviewBuyThengPdfPage extends StatefulWidget {
  ...
  @override
  State<PreviewBuyThengPdfPage> createState() => _PreviewBuyThengPdfPageState();
}

class _PreviewBuyThengPdfPageState extends State<PreviewBuyThengPdfPage> {
  int option = 1;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PdfPreview(
        build: (context) => widget.shop == true
            ? makeBuyThengBill(widget.invoice, option: option)
            : makeBuyUsedThengBill(widget.invoice, option: option),
      ),
    );
  }
