...
class EditSellThengDialog extends StatefulWidget {
  const EditSellThengDialog({super.key, required this.index, this.j});

  final int index;
  final int? j;

  @override
  State<EditSellThengDialog> createState() => _EditSellThengDialogState();
}

class _EditSellThengDialogState extends State<EditSellThengDialog> {
  bool loading = false;
