...
class AddBuyItemDialog extends StatefulWidget {
  const AddBuyItemDialog({super.key, required this.index});

  final int index;

  @override
  State<AddBuyItemDialog> createState() => _AddBuyItemDialogState();
}

class _AddBuyItemDialogState extends State<AddBuyItemDialog> {
  bool loading = false;
          ...
          if (txt == 'price') {
            ...
            var realPrice = Global.getBuyPrice(
                Global.toNumber(productWeightCtrl
                    .text), Global.goldDataModel); //Global.toNumber(productPriceBaseCtrl.text);
