...
class _NewProductScreenState extends State<NewProductScreen> {
  ...
  void initState() {
    ...
    productCategoryNotifier =
        ValueNotifier<ProductCategoryModel>(ProductCategoryModel(id: 0, name: 'เลือกหมวดหมู่'));
    productNotifier =
        ValueNotifier<ProductModel>(ProductModel(name: 'เลือกสินค้า', id: 0));
    typeNotifier = ValueNotifier<ProductTypeModel>(ProductTypeModel(id: 0, name: 'เลือกสถานะสินค้า'));
    productCodeCtrl.text = generateRandomString(10).toUpperCase();
    loadData();
  }
        ...
        SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                ...
                try {
                  var result = await ApiServices.post('/product/create', object);
                  await pr.hide();
                  if (result?.status == "success") {
                    if (mounted) {
